...
export function HeaderBase({
  ...
  return (
    <header
      ref={headerRef}
      className={cn(
        "flex w-full flex-col overflow-hidden border backdrop-blur-lg bg-secondary dark:bg-background px-4 transition-all duration-300 ease-in-out rounded-none",
        className,
      )}
    >
      {/* Top bar */}
