...
export const metadata: Metadata = {
  ...
  description:
    "Create stunning career pages, post job openings, and manage applicants with WeGotWork's all-in-one hiring platform. Start hiring top talent today with our easy-to-use recruitment tools.",
  keywords: [
    "career pages",
  ...
  openGraph: {
    title: "WeGotWork - Build Beautiful Career Pages & Hire Top Talent",
    description:
      "Create stunning career pages, post job openings, and manage applicants with WeGotWork's all-in-one hiring platform. Start hiring top talent today.",
  ...
  twitter: {
    ...
    title: "WeGotWork - Build Beautiful Career Pages & Hire Top Talent",
    description:
      "Create stunning career pages, post job openings, and manage applicants with WeGotWork's all-in-one hiring platform.",
        ...
        <div className="flex flex-col items-center p-4 -mt-4">
          <div className="flex flex-row w-full lg:w-[60%] items-center justify-center content-center gap-4 mt-6">
            <Button
              variant={"outline"}
              asChild
              className="px-4 w-full rounded-none font-bold border-dashed bg-theme"
            >
              <Link
          ...
          <div className="not-prose my-8 lg:w-[60%] w-full space-y-4">
            <LandingPageJobCard
              ...
              type="Full-Time"
              location="Cairo, EG"
              age="about 1 month ago"
              category="Operations"
            />
            <LandingPageJobCard
              title="Financial Advisor"
              type="Part-Time"
              location="Brussels, EG"
              age="about 1 month ago"
              category="Finance"
            />
