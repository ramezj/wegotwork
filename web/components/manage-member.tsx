...
export function ManageMember({
  ...
  OrganizationUser: OrganizationUserWithUser;
}) {
  return (
    <>
      <Dialog>
        ...
        <DialogContent
          ...
          className="w-[90%] rounded-md bg-black"
        >
          <DialogHeader>
            <DialogTitle className="">Manage Team Member</DialogTitle>
            <DialogDescription>
              View and manage team member details and permissions.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-medium">
                  {formatRole(OrganizationUser.role)}
                </p>
              </div>
            </div>
          </div>
