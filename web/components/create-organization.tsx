    ...
    <>
      <Dialog>
        <DialogTrigger asChild>
          <Button
            variant={"outline"}
            className="font-medium w-full bg-theme border border-dashed rounded-none"
          >
        ...
        <DialogContent className="w-[90%] bg-theme border border-dashed !rounded-none">
          <DialogHeader>
            <DialogTitle className="text-left text-xl font-medium text-white">
              Create Organization
            </DialogTitle>
          </DialogHeader>
          <form
            className="grid items-center gap-3 text-left"
            onSubmit={create_organization}
          >
