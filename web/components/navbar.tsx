    ...
    <div className="flex w-full flex-col">
      <header className="sticky flex h-16 items-center gap-4 z-50 border-b border-foreground/20 backdrop-blur-lg w-full">
        <nav className="hidden flex-col text-lg font-medium md:flex md:flex-row md:items-center md:text-sm">
          <Link
            href="/"
            className="flex items-center text-lg font-bold italic px-2"
          >
            heliup
          </Link>
          {/* <NavigationMenuForNavbar /> */}
          ...
          >
            <SheetTitle>
              <SheetClose asChild>
                <Link
                  href="/"
                  className="px-2 flex items-center text-lg font-bold justify-center italic"
                >
                  heliup
                </Link>
              </SheetClose>
            ...
            <nav className="grid gap-3 text-lg font-medium mt-1">
              <SheetClose asChild>
                <Link
                  href="https://demo.heliup.xyz"
                  className={`${path == "jobs" ? "bg-muted/50 text-foreground" : " text-muted-foreground"} flex items-center gap-3 rounded-lg px-2 py-2 text-primary transition-all hover:text-primary hover:bg-muted/50 duration-200 font-medium`}
                >
                  <Laptop className="h-4 w-4" />
                  Features
                </Link>
              ...
              <SheetClose asChild>
                <Link
                  href="/pricing"
                  className={`${path == "applicants" ? "bg-muted/50 text-foreground" : " text-muted-foreground"} flex items-center gap-3 rounded-lg px-2 py-2 text-primary transition-all hover:text-primary hover:bg-muted/50 duration-200 font-medium`}
                >
                  <DollarSignIcon className="h-4 w-4" />
                  Pricing
                </Link>
          ...
          <div className="ml-auto align-middle flex gap-3">
            {session?.user ? (
              <>
                <Button
                  variant={"ghost"}
                  className="border-l h-16 rounded-none"
                >
              ...
              <>
                ...
                <Button
                  variant="outline"
                  asChild
                  className="duration-200 hidden md:block"
                >
