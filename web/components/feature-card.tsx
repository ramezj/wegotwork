  ...
  return (
    <Card className="flex flex-col h-full rounded-sm bg-white border border-black">
      <CardHeader>
        ...
        <CardDescription className="text-base font-medium text-black">{description}</CardDescription>
      </CardHeader>
      <CardFooter className="mt-auto pt-4">
        <Button variant={"default"} className="font-medium bg-black text-white hover:bg-black hover:text-white rounded-sm">
          <Link href={ctaLink} className="flex items-center gap-2 hover:gap-3 transition-all">
