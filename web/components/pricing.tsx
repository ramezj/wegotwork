  ...
  return (
    <>
      <Card className="w-[350px] bg-theme rounded-none border border-dashed">
        <CardHeader>
          <CardTitle className="flex gap-2 font-bold text-white tracking-normal">
            Free
          </CardTitle>
          ...
          <div className="grid w-full items-center gap-4">
            ...
            <div className="flex flex-col space-y-1.5">
              <h2 className="flex gap-2 text-white font-medium">
                <CircleCheck className="text-white" />1 Organization
              </h2>
            </div>
            <div className="flex flex-col space-y-1.5">
              <h2 className="flex gap-2 text-white font-medium">
                <CircleCheck className="text-white" />3 Jobs
              </h2>
            </div>
            <div className="flex flex-col space-y-1.5">
              <h2 className="flex gap-2 text-white font-medium">
      ...
      <Card className="w-[350px] bg-theme rounded-none border border-dashed">
        ...
        <CardContent>
          <div className="grid w-full items-center gap-4">
            ...
            <div className="flex flex-col space-y-1.5">
              <h2 className="flex gap-2 text-white font-medium">
                <CircleCheck className="text-white" />5 Organizations
              </h2>
            </div>
            <div className="flex flex-col space-y-1.5">
              <h2 className="flex gap-2 text-white font-medium">
