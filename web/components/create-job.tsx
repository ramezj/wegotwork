    ...
    <>
      <Dialog>
        <DialogTrigger asChild>
          <Button
            className={`dark:bg-theme bg-gray-200 hover:bg-gray-200 text-foreground px-4 font-bold rounded-none border-dashed ${className || ""}`}
            variant={"outline"}
            {...buttonProps}
          >
            Create Job
        ...
        >
          ...
          <DialogFooter>
            <Button
              ...
              type="submit"
              variant={"default"}
              className="px-4 text-white bg-blueColor hover:bg-blueColor w-full font-medium rounded-none"
            >
              {loading ? (
