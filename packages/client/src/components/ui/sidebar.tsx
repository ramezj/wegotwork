    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground w-(--sidebar-width) p-0 data-[mobile=true]:data-[state=open]:duration-200 data-[mobile=true]:data-[state=closed]:duration-200 [&>button]:hidden"
          style={
            {
